...
public class InterpreterPathChooser extends BaseListPopupStep<String>
{
	...
	{
		if(LOCAL.equals(aValue) || REMOTE.equals(aValue) || VIRTUALENV.equals(aValue))
		{
			return null;
		}
	...
	private void createSdkFromPath(String selectedPath)
	{
		...
		Sdk sdk = SdkConfigurationUtil.setupSdk(myExistingSdks, LocalFileSystem.getInstance().findFileByPath(filePath), PythonSdkType.getInstance(),
