...
public class PyUnboundLocalVariableInspection extends PyInspection
{
	...
	public static class Visitor extends PyInspectionVisitor
	{
		...
		{
			registerProblem((owner instanceof PyFunction) ? ((PyFunction) owner).getNameIdentifier() : owner, PyBundle.message("INSP.unbound.function.too.large", owner.getName()), ProblemHighlightType.WEAK_WARNING);
		}
	}
}
