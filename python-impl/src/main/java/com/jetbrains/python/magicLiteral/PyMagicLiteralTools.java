...
public final class PyMagicLiteralTools
{
	 ...
	 */
	private final static PsiCacheKey<Ref<PyMagicLiteralExtensionPoint>, StringLiteralExpression> MAGIC_LITERAL_POINT = PsiCacheKey.create(PyMagicLiteralTools.class.getName(),
	...
	private static class MagicLiteralChecker implements Function<StringLiteralExpression, Ref<PyMagicLiteralExtensionPoint>>
	{
		...
		{
			final PyMagicLiteralExtensionPoint[] magicLiteralExtPoints = ApplicationManager.getApplication().getExtensions(PyMagicLiteralExtensionPoint.EP_NAME);
