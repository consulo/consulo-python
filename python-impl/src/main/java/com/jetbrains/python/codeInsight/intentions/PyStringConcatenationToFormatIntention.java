...
public class PyStringConcatenationToFormatIntention extends PyBaseIntentionAction
{
	...
	public boolean isAvailable(@NotNull Project project, Editor editor, PsiFile file)
	{
		...
		for(PyExpression expression : expressions)
		{
			...
			final boolean isStringReference = PyTypeChecker.match(cache.getStringType(LanguageLevel.forElement(expression)), type, TypeEvalContext.codeAnalysis(file.getProject(), file)) && type !=
					null;
