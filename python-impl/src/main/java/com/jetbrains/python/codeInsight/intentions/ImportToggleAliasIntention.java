	...
	public void doInvoke(@Nonnull final Project project, Editor editor, PsiFile file) throws IncorrectOperationException
	{
		...
		try
		{
			...
			else
			{
				...
				{
					String alias = Messages.showInputDialog(project, PyBundle.message("INTN.alias.for.$0.dialog.title", imported_name), "Add Alias", Messages.getQuestionIcon(), "", new
							InputValidator()
					{
						@Override
			...
			if(referee != null && imported_name != null)
			{
				...
				else
				{
					...
					PyImportElement fountain = generator.createFromText(languageLevel, PyImportElement.class, "import foo as " + target_name, new int[]{
							0,
							2
					});
