 ...
 *
 * <p>Not marked are cases of inheritance calls in old-style classes, like:<pre>
 * class B(A):
 *   def foo(self):
 *     A.foo(self)
 * </pre></p>
...
public class PyCallByClassInspection extends PyInspection {
    ...
    public LocalizeValue getDisplayName() {
        return PyLocalize.inspNameDifferentClassCall();
    }
                                            ...
                                            if (entry.getValue() == first_param) {
                                                ...
                                                if (first_arg_type instanceof PyClassType) {
                                                    ...
                                                    if (first_arg_class_type.isDefinition() && markedCallee.getModifier() != CLASSMETHOD) {
                                                        registerProblem(
                                                            first_arg,
                                                            PyLocalize.inspInstanceOf$0Excpected(qual_class.getQualifiedName()).get()
                                                        );
                                                    }
                                                    ...
                                                    if (first_arg_class != qual_class) {
                                                        ...
                                                        if (markedCallee.getCallable() instanceof PyFunction) {
                                                            ...
                                                            if (callable != null) {
                                                                ...
                                                                if (method != null) {
                                                                    ...
                                                                    if (first_arg_class.isSubclass(
                                                                        qual_class,
                                                                        myTypeEvalContext
                                                                    ) && calling_class.isSubclass(
                                                                        qual_class,
                                                                        myTypeEvalContext
                                                                    )) {
                                                                        break;
                                                        ...
                                                        registerProblem(
                                                            first_arg,
                                                            PyLocalize.inspPassing$0InsteadOf$1(
                                                                first_arg_class.getQualifiedName(),
                                                                qual_class.getQualifiedName()
                                                            ).get()
                                                        );
                                                    }
                                                }
