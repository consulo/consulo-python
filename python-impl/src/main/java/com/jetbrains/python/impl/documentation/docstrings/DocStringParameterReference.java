...
public class DocStringParameterReference extends PsiReferenceBase<PyStringLiteralExpression> implements PsiReferenceEx
{
	...
	{
		PARAMETER, PARAMETER_TYPE, KEYWORD, VARIABLE, CLASS_VARIABLE, INSTANCE_VARIABLE, GLOBAL_VARIABLE
	}
	...
	public PsiElement resolve()
	{
		...
		if(owner instanceof PyClass)
		{
			...
			else
			{
				...
				if(myType.equals(ReferenceType.INSTANCE_VARIABLE) || myType.equals(ReferenceType.PARAMETER_TYPE))
				{
	...
	@Nullable
	private PsiElement resolveGlobalVariable(PyFile owner)
	{
	...
	@Nullable
	private PsiElement resolveClassVariable(PyClass owner)
	{
