...
import com.jetbrains.python.impl.remote.PyRemotePathMapper.PyPathMappingType;
import com.jetbrains.python.impl.run.PyRemoteProcessStarterManager;
import com.jetbrains.python.impl.sdk.skeletons.PySkeletonGenerator;
...
public abstract class PythonRemoteInterpreterManager {
  ...
  /**
   * @deprecated use {@link PyRemoteProcessStarterManager#startRemoteProcess(Project, GeneralCommandLine, PythonRemoteInterpreterManager, PyRemoteSdkAdditionalDataBase,
   * PyRemotePathMapper)}
   */
  @Deprecated
  ...
  /**
   * @deprecated use {@link PyRemoteProcessStarterManager#executeRemoteProcess(Project, String[], String, PythonRemoteInterpreterManager, PyRemoteSdkAdditionalDataBase,
