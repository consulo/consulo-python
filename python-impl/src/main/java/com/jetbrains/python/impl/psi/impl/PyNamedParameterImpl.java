...
public class PyNamedParameterImpl extends PyBaseElementImpl<PyNamedParameterStub> implements PyNamedParameter {
    ...
    public PyType getType(@Nonnull TypeEvalContext context, @Nonnull TypeEvalContext.Key key) {
        ...
        if (parent instanceof PyParameterList parameterList) {
            ...
            if (func != null) {
                PyType typeFromProvider =
                    parameterList.getApplication().getExtensionPoint(PyTypeProvider.class).computeSafeIfAny(provider -> {
                        SimpleReference<PyType> resultRef = provider.getParameterType(this, func, context);
        ...
        if (owner != null && name != null) {
            owner.accept(new PyRecursiveElementVisitor() {
                    ...
                    if (node instanceof PyQualifiedExpression expr) {
                        ...
                        if (qualifier != null) {
                            ...
                            PyExpression referencedExpr =
                                node instanceof PyBinaryExpression binExpr && PyNames.isRightOperatorName(attributeName)
                            ...
                            if (ref != null && ref.isReferenceTo(PyNamedParameterImpl.this)) {
                                ...
                                if (parameter != null) {
                                    ...
                                    if (type instanceof PyStructuralType structuralType) {
                                        result.addAll(structuralType.getAttributeNames());
                                    }
                                }
                            }
                        }
                ...
                public void visitPyCallExpression(PyCallExpression node) {
                    Optional.ofNullable(node.getCallee())
    ...
    private PyNamedParameter getParameterByCallArgument(@Nonnull PsiElement element, @Nonnull TypeEvalContext context) {
        ...
        if (argumentList != null) {
            ...
            if (elementIsArgument && callExpression != null) {
                if (callExpression.getCallee() instanceof PyReferenceExpression calleeRefExpr) {
                    PyExpression firstQualifier = PyPsiUtils.getFirstQualifier(calleeRefExpr);
        ...
        if (file != null && name != null) {
            ...
            for (int pos = text.indexOf(name); pos != -1; pos = text.indexOf(name, pos + 1)) {
                ...
                if (ref != null && ref.isReferenceTo(function)) {
                    ...
                    if (expr != null && !processor.test(expr)) {
                        return;
                    }
                }
            }
