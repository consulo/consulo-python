...
public interface PyElementTypes {
  ...
  TokenSet BINARY_OPS = TokenSet.create(PyTokenTypes.OR_KEYWORD,
  ...
  TokenSet UNARY_OPS =
    TokenSet.create(PyTokenTypes.NOT_KEYWORD, PyTokenTypes.PLUS, PyTokenTypes.MINUS, PyTokenTypes.TILDE, PyTokenTypes.AWAIT_KEYWORD);
