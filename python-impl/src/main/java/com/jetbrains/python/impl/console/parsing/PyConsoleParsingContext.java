...
import com.jetbrains.python.impl.parsing.ParsingScope;
...
public class PyConsoleParsingContext extends ParsingContext
{
	...
	public static class ConsoleStatementParsing extends StatementParsing
	{
		...
		protected ConsoleStatementParsing(ParsingContext context, @Nullable FUTURE futureFlag, boolean startsWithIPythonSymbol, PythonConsoleData pythonConsoleData)
		{
