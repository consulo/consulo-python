...
import org.consulo.python.psi.PyGlobalStatement;
import org.consulo.python.psi.PyReferenceExpression;
...
public class PyGlobalStatementImpl extends PyElementImpl
	...
	public PyReferenceExpression[] getGlobals() {
		return childrenToPsi(this.REFERENCES, PyReferenceExpression.EMPTY_ARRAY);
	}
