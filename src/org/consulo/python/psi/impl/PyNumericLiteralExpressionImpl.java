...
import org.consulo.python.psi.PyNumericLiteralExpression;
...
public class PyNumericLiteralExpressionImpl extends PyElementImpl
	...
	private static final Pattern PATTERN_INT = Pattern.compile("(?:([1-9]\\d*)|(0)|(0[0-7]+)|(?:0x([0-9a-f]+)))L?", Pattern.CASE_INSENSITIVE);

	private static final Pattern PATTERN_FLOAT = Pattern.compile("((\\d+)(?:\\.(\\d+)?)?|\\.(\\d+))(e(\\+|-)?(\\d))?", Pattern.CASE_INSENSITIVE);
