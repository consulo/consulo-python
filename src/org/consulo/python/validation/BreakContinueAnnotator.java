...
import org.consulo.python.psi.PyBreakStatement;
import org.consulo.python.psi.PyContinueStatement;
import org.consulo.python.psi.PyTryFinallyStatement;
...
public class BreakContinueAnnotator extends PyAnnotator {
	...
	public void visitPyContinueStatement(PyContinueStatement node) {
		...
		PyTryFinallyStatement tryStatement = node.getContainingElement(PyTryFinallyStatement.class);
