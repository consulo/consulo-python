  ...
  implements ParserDefinition
{
  ...
  {
    void tmp11_8 = new PythonIndentingLexer(this.language); if (tmp11_8 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp11_8;
  }
  ...
  {
    TokenSet tmp4_1 = this.myWhitespaceTokens; if (tmp4_1 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp4_1;
  }

  @NotNull
  public TokenSet getCommentTokens()
  {
    TokenSet tmp4_1 = this.myCommentTokens; if (tmp4_1 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp4_1;
  }

  @NotNull
  public PsiParser createParser(Project project)
  {
    void tmp11_8 = new PyParser(this.language); if (tmp11_8 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp11_8;
  }
  ...
  public PsiElement createElement(ASTNode node) {
    ...
    if ((type instanceof PyElementTypeImpl)) {
      ...
      PsiElement tmp25_22 = createElement(pyElType, node); if (tmp25_22 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp25_22;
    }
    void tmp48_45 = new ASTWrapperPsiElement(node); if (tmp48_45 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp48_45;
  }
