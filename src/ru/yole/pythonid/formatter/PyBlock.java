  ...
  implements Block
{
  ...
  {
    ASTNode tmp4_1 = this._node; if (tmp4_1 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp4_1;
  }

  @NotNull
  public TextRange getTextRange()
  {
    TextRange tmp9_4 = this._node.getTextRange(); if (tmp9_4 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp9_4;
  }
  ...
  public List<Block> getSubBlocks() {
    ...
    List tmp19_16 = this._subBlocks; if (tmp19_16 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp19_16;
  }
  ...
  public ChildAttributes getChildAttributes(int newChildIndex)
  {
    ...
    while (lastChild != null) {
      ...
      {
        ChildAttributes tmp112_109 = ChildAttributes.DELEGATE_TO_PREV_CHILD; if (tmp112_109 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp112_109;
      }
    ...
    if (statementListsBelow > 1) {
      ...
      void tmp174_171 = new ChildAttributes(Indent.getSpaceIndent(indent * statementListsBelow), null); if (tmp174_171 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp174_171;
    }
    void tmp205_202 = new ChildAttributes(getChildIndent(newChildIndex), getChildAlignment()); if (tmp205_202 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp205_202;
  }
