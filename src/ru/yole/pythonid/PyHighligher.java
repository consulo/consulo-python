...
public class PyHighligher extends SyntaxHighlighterBase
{
  ...
  {
    void tmp11_8 = new PythonLexer(this.language); if (tmp11_8 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp11_8;
  }
  ...
  {
    TextAttributesKey[] tmp15_12 = pack((TextAttributesKey)keys1.get(tokenType)); if (tmp15_12 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp15_12;
  }
}