  ...
  implements PyClass
{
  ...
  {
    PyStatementList tmp17_14 = ((PyStatementList)childToPsiNotNull(getLanguage().getElementTypes().STATEMENT_LIST)); if (tmp17_14 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp17_14;
  }
