  ...
  implements PyIfStatement
{
  ...
  public PyStatementList[] getStatementLists() {
    ...
    if (statementLists.length > conditions.length) {
      ...
      PyStatementList[] tmp91_89 = result; if (tmp91_89 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp91_89;
    }
    PyStatementList[] tmp107_106 = statementLists; if (tmp107_106 == null) throw new IllegalStateException("@NotNull method must not return null"); return tmp107_106;
  }
  @Nullable
