...
public class PyUtil
{
  ...
  public static PythonReferenceProviderRegistry getReferenceProviderRegistry() {
    return getLanguage().getReferenceProviderRegistry();
  }
  ...
  public static PsiElement addLineToExpressionIfMissing(PyExpression expr, PyExpression add, String line, boolean forceAdd, Comparator<String> comparator)
  {
      ...
      if ((comparator != null) && ((add instanceof PyStringLiteralExpression)))
      {
        ...
        try {
          if (after == null) {
            ...
            return listExp.addBefore(add, (PsiElement)literals.get(0));
          }
    ...
    if (forceAdd) {
      PyListLiteralExpression listLiteral = expr.getLanguage().getElementGenerator().createListLiteral(project);
      PsiElement added;
      try {
      ...
      PyBinaryExpression binExpr = expr.getLanguage().getElementGenerator().createBinaryExpression(project, "+", expr, listLiteral);
