...
public class ProtocolParser
{
	...
	public static String getThreadId(String payload)
	{
	...
	private static void parseArrayHeaderData(XppReader reader, ArrayChunkBuilder result) throws PyDebuggerException
	{
		...
		while(reader.hasMoreChildren())
		{
			...
			{
				colHeaders.add(new ArrayChunk.ColHeader(readString(reader, "label", null), readString(reader, "type", null), readString(reader, "format", null), readString(reader, "max", null),
