...
class TypeEvalConstraints
{
	...
	public boolean equals(Object o)
	{
		...
		if(!(o instanceof TypeEvalConstraints))
		{
			return false;
		}
		...
		if(myAllowDataFlow != that.myAllowDataFlow)
		{
			return false;
		}
		if(myAllowStubToAST != that.myAllowStubToAST)
		{
			return false;
		}
		if(myAllowCallContext != that.myAllowCallContext)
		{
			return false;
		}
		if(myOrigin != null ? !myOrigin.equals(that.myOrigin) : that.myOrigin != null)
		{
			return false;
		}
