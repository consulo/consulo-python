...
public class PyPsiUtils
{
	...
	{
		//noinspection ConstantConditions
		return element instanceof PyFile || element instanceof PyStatementList ? (PyElement) element : PsiTreeUtil.getParentOfType(element,
				PyFile.class,
	...
	@Nonnull
	public static <T, U extends PsiElement> List<T> collectStubChildren(U e,
