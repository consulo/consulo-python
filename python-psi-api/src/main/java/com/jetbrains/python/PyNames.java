...
public class PyNames {
   ...
   */
  public static Set<String> UnderscoredAttributes =
    Set.of("__all__",
           "__annotations__",
           "__author__",
           "__bases__",
  ...
  public static Set<String> COMPARISON_OPERATORS =
    Set.of("__eq__", "__ne__", "__lt__", "__le__", "__gt__", "__ge__", "__cmp__", "__contains__");

  public static Set<String> SUBSCRIPTION_OPERATORS = Set.of(GETITEM, SETITEM, DELITEM);
  ...
  private static final Map<String, BuiltinDescription> BuiltinMethods =
    ImmutableMap.<String, BuiltinDescription>builder().put("__abs__", _only_self_descr)
                                                      .put("__add__",
                                                           _self_other_descr)
                                                      ...
                                                      .put
                                                        ("__getinitargs__", _only_self_descr)
  ...
  public static ImmutableMap<String, BuiltinDescription> PY2_BUILTIN_METHODS =
    ImmutableMap.<String, BuiltinDescription>builder().putAll(BuiltinMethods).put("__nonzero__", _only_self_descr).put
      ("__div__", _self_other_descr).put(NEXT, _only_self_descr).build();

  public static ImmutableMap<String, BuiltinDescription> PY3_BUILTIN_METHODS =
    ImmutableMap.<String, BuiltinDescription>builder().putAll(BuiltinMethods)
                                                      .put("__bool__", _only_self_descr)
                                                      .put
                                                        ("__bytes__", _only_self_descr)
                                                      .put("__format__", new BuiltinDescription("(self, format_spec)"))
                                                      .put("__instancecheck__", new BuiltinDescription("(self, instance)"))
                                                      .put("__prepare__",
                                                           new BuiltinDescription("(metacls, name, bases)"))
                                                      .put("__round__", new BuiltinDescription("(self, n=None)"))
                                                      .put("__subclasscheck__", new BuiltinDescription("(self, subclass)"))
                                                      .put
                                                        (DUNDER_NEXT, _only_self_descr)
                                                      .build();

  public static ImmutableMap<String, BuiltinDescription> PY35_BUILTIN_METHODS =
    ImmutableMap.<String, BuiltinDescription>builder().putAll(PY3_BUILTIN_METHODS)
  ...
  public static final ImmutableMap<String, BuiltinDescription> PY36_BUILTIN_METHODS =
    ImmutableMap.<String, BuiltinDescription>builder().putAll(PY35_BUILTIN_METHODS).put(INIT_SUBCLASS, new
   ...
   */
  public static Set<String> Keywords = Set.of(AND,
                                              DEL,
                                              FROM,
                                              NOT,
                                              WHILE,
  ...
  public static Set<String> BuiltinInterfaces = Set.of(CALLABLE,
                                                       HASHABLE,
                                                       ITERABLE,
                                                       ITERATOR,
                                                       SIZED,
   ...
   */
  public static final Set<String> FUNCTION_SPECIAL_ATTRIBUTES =
    Set.of("__defaults__", "__globals__", "__closure__", "__code__", "__name__");

  public static final Set<String> LEGACY_FUNCTION_SPECIAL_ATTRIBUTES =
    Set.of("func_defaults", "func_globals", "func_closure", "func_code", "func_name", "func_doc", "func_dict");

  public static final Set<String> PY3_ONLY_FUNCTION_SPECIAL_ATTRIBUTES = Set.of("__annotations__", "__kwdefaults__");

  public static final Set<String> METHOD_SPECIAL_ATTRIBUTES = Set.of("__func__", "__self__");
