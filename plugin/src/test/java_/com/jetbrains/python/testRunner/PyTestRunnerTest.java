...
public abstract class PyTestRunnerTest extends LightPlatformTestCase {
  ...
  public void testDependent() throws ExecutionException {
    File testDir = new File(PythonTestUtil.getTestDataPath(), "testRunner");
  ...
  private static String[] runUTRunner(String workDir, String... args) throws ExecutionException {
    ...
    ProcessOutput output = JythonUnitTestUtil.runJython(workDir, helpersDir.getPath(), ArrayUtil.toStringArray(allArgs));
  ...
  private static String[] splitLines(String out) {
    ...
    String[] lines = StringUtil.convertLineSeparators(out).split("\n");
