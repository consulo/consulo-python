...
public abstract class PyTypeParserTest extends PyTestCase {
  ...
  public void testDictType() {
    ...
    final PyType elementType = type.getElementTypes(getTypeEvalContext()).get(0);
  ...
  public void testParenthesesPriority() {
    ...
    final List<PyType> elementType = collectionType.getElementTypes(TypeEvalContext.codeInsightFallback(myFixture.getProject()));
